...
set_property -dict { PACKAGE_PIN T16   IOSTANDARD LVCMOS33 } [get_ports { sw }]; #IO_L9P_T1_DQS_34 Sch=SW3
...
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { btn- }]; #IO_L7P_T1_34 Sch=BTN3


##LEDs
#set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { ledin }]; #IO_L23P_T3_35 Sch=LED0
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { ledsw }]; #IO_L3N_T0_DQS_AD1N_35 Sch=LED3
